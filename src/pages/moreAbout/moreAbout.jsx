    ...
    <div className="bg-white border border-4 rounded-lg shadow relative m-10">
      ...
      <div className="p-6 space-y-6">
        <form action="#">
          ...
          <button type="button" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300  font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Save</button>
